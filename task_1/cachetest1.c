...
int main (int argc, char *argv[])
{
  ...
  /***************************************/
    ...
    sum = 0;
    for(int index = 0; index < N; index++) {
      // Using a[index] instead of a[b[index]] decreases the time.
      // This could potentially be because the program has to access another
      // array b and has to deal with its cache as well.
      sum = sum + a[b[index]];
    }
  }
  /***************************************/
